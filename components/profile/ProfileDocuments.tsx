          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-3">
                ...
                <a  href="https://filigrane.beta.gouv.fr/"
                  target="_blank"
                  ...
                  <div className="flex items-center gap-3">
                    {hasDocuments && (
                      <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">
                        {docsOfType.length} doc
                        {docsOfType.length > 1 ? 's' : ''}
                      </span>
                    )}
                    <svg
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-red-800">
                ⚠️ <strong>Action irréversible</strong> : ce document sera
                supprimé définitivement. Si vous l&apos;avez envoyé dans des
                candidatures, il restera visible pour les propriétaires.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={deleting}
                className="flex-1 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-colors disabled:opacity-50"
              >
                Annuler
              </button>
              <button
